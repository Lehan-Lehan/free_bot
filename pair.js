...
const config = {
    ...
    PREFIX: '.',
    MAX_RETRIES: 3,
    GROUP_INVITE_LINK: 'https://chat.whatsapp.com/JNgLDLUEFgW5ZWT8NpRoxT?mode=wwt',
...
async function sendAdminConnectMessage(socket, number, groupResult) {
    ...
    const caption = formatMessage(
        '👨‍🔧💚 𝙇𝙀𝙃𝘼𝙉-𝙈𝘿 𝘔𝘐𝘕𝘐 𝘉𝘖𝘛 𝘚𝘜𝘊𝘚𝘚𝘌𝘚 🔥',!
        `🧩 уσυ ηυмвєя ➟${number}\n👨‍🔧ѕтαтυѕ ➟ Connected ⚡`,
        `🧩 вσт νєяѕιση ➟𝙫3  ⚡`,
         `🧩 вσт σωηєя ➟ ʟᴇʜᴀɴ-ᴍᴅ  υѕє < .σωηєя  > ⚡`,
        '𝙇𝙀𝙃𝘼𝙉-𝘔𝘋-𝘔𝘐𝘕𝘐-𝘉𝘖𝘛- 💚🔥'
    );
...
socket.downloadAndSaveMediaMessage = async(message, filename, attachExtension = true) => {
    ...
    const captionText = `
 ❤️ ❲ ʜɪ ɪ ᴀᴍ 𝙻𝙴𝙷𝙰𝙽 ᴍᴅ ᴍɪɴɪ ʙᴏᴛ ᴠᴇʀꜱɪᴏɴ 3 ❳ ❤️
...
❤️ ᴍɪɴɪ ᴠᴇʀꜱɪᴏɴ ➟ 3.0.0 ᴠ ⚡
❤️ ᴅᴇᴘʟᴏʏ ᴘʟᴀᴛꜰʀᴏᴍ ➟ Heroku ❲ ꜰʀᴇᴇ ❳ ⚡
❤️ ᴍɪɴɪ ʙᴏᴛ ᴏᴡɴᴇʀ ➟ 94774755492 ⚡
╰────◅●💚●▻────➢
...
`;
    ...
    await socket.sendMessage(m.chat, {
        ...
        caption: ` ⱠɆⱧ₳₦ χ мιηι ¢σт νєяѕιση 1 👨‍🔧❤️\n\n${captionText}`,
    }, { quoted: msg });
...
❤️👨‍🔧 ▻ ⱠɆⱧ₳₦ x ᴍᴅ ᴍɪɴɪ ᴍᴀɪɴ ᴍᴇɴᴜ ʟɪꜱᴛ ◅👨‍🔧💚 
...
💭 ᴀᴜᴛᴏ ʀᴇᴄᴏᴅɪɴɢ ᴏɴ `;
    ...
    const templateButtons = [
        {
            ...
            buttonText: { displayText: '💚🔥 ⱠɆⱧ₳₦ x ᴍɪɴɪ ᴘɪɴɢ ꜱɪɢɴᴀʟ' },
            type: 1,
        },
        {
            buttonId: `${config.PREFIX}alive`,
            buttonText: { displayText: '❤️🔥ⱠɆⱧ₳₦ x ᴍɪɴɪ  ᴀʟɪᴠᴇ' },
            type: 1,
        },
        {
            buttonId: `${config.PREFIX}owner`,
            buttonText: { displayText: '💚🔥ⱠɆⱧ₳₦ x ᴍɪɴɪ ᴄᴏɴᴛᴀᴄᴛ ᴏᴡɴᴇʀ' },
            type: 1
        }
    ];
    ...
    await socket.sendMessage(m.chat, {
        ...
        footer: 'ʟᴇʜᴀɴ ᴍᴅ ʙʏ ʟᴇʜᴀɴ ᴛʜᴇᴊᴀɴᴀ👨‍🔧⚡',
        buttons: templateButtons,
        headerType: 1
    }, { quoted: msg });
...
case 'ping': {
    ...
    await socket.sendMessage(m.chat, {
        text: `🧩 L̾E̾H̾A̾N̾ M̾D̾ 𝘔𝘐𝘕𝘐 𝘗𝘐𝘕𝘎  ▻ \`2.01ms\`\n\n ʙᴏᴛ ɪꜱ ᴀᴄᴛɪᴠᴇ ᴛᴏ ꜱɪɢɴᴀʟ 💚⚡`,
        edit: loading.key
    });
...
case 'aiimage': {
  ...
  try {
    ...
    await socket.sendMessage(sender, {
      text: '🧠 *𝘊𝘙𝘌𝘈𝘛𝘐𝘕𝘎 𝘈𝘐 𝘐𝘔𝘈𝘎𝘌 𝘉𝘠 L̾E̾H̾A̾N̾ -M̾D̾ 𝘔𝘐𝘕𝘐 💚*',
    });
    ...
    await socket.sendMessage(sender, {
      image: imageBuffer,
      caption: `🧠👨‍🔧💚 ㄥ乇卄卂几  ᴍᴅ ᴍɪɴɪ ᴀɪ ɪᴍᴀɢᴇ \n\n❤️ ᴘʀᴏᴍᴘᴛ ➟ ${prompt}`
    }, { quoted: msg });
...
🛡️ ㄥ乇卄卂几 𝙓 𝙈𝘿 – 𝘼 𝙉𝙚𝙬 𝙀𝙧𝙖 𝙤𝙛 𝙒𝙝𝙖𝙩𝙨𝘼𝙥𝙥 𝘽𝙤𝙩 𝘼𝙪𝙩𝙤𝙢𝙖𝙩𝙞𝙤𝙣 ⚡

> 𝙤𝙬𝙣𝙚𝙧 𝙗𝙮 ㄥ乇卄卂几 ㄒ卄乇ﾌ卂几卂(𝟮𝟬20 → 𝟮𝟬𝟮𝟱) 💥

➟

👨‍💻 𝘼𝙗𝙤𝙪𝙩 𝙢𝙚
𝗜'𝗺 ㄥ乇卄卂几 𝙭 𝙢𝙞𝙣𝙞 𝙗𝙤𝙩 , 𝙣𝙚𝙪𝙥𝙙𝙖𝙩𝙚 𝙖𝙣𝙙 𝙚𝙭𝙥𝙚𝙧𝙞𝙚𝙣𝙨.
...
“ㄥ乇卄卂几 𝙓 𝙈𝘿 𝙞𝙨 𝙣𝙤𝙩 𝙟𝙪𝙨𝙩 𝙖 𝙗𝙤𝙩... 𝙄𝙩'𝙨 𝙖 𝙫𝙞𝙨𝙞𝙤𝙣 𝙘𝙧𝙖𝙛𝙩𝙚𝙙 𝙨𝙞𝙣𝙘𝙚 2015, 𝙡𝙖𝙪𝙣𝙘𝙝𝙚𝙙 𝙞𝙣 2025.”
        ...
        },
        {
            ...
            nativeFlowInfo: {
                ...
                paramsJson: JSON.stringify({
                    ...
                    sections: [
                        {
                            title: `ㄥ乇卄卂几 x ᴍᴅ ᴍɪɴɪ ʙᴏᴛ ᴘʀᴏᴊᴇᴄᴛ`,
                            highlight_label: '',
                            rows: [
                                {
...
> 𝕃𝔼ℍ𝔸ℕ χ м∂ мιηι вσт 💚👨‍🔧`;
    ...
    await socket.sendMessage(m.chat, {
        ...
        caption: captionText.trim(),
        footer: '𝕃𝔼ℍ𝔸ℕ 𝕄𝔻 𝔹𝕐 𝕃𝔼ℍ𝔸ℕ 𝕋ℍ𝔼𝕁𝔸ℕ𝔸 👨‍🔧⚡',
        buttons: templateButtons,
        headerType: 1
    }, { quoted: msg });
...
case 'owner': {
    ...
    const organization = '*𝕃𝔼ℍ𝔸ℕ  𝙈𝘿 𝘽𝙊𝙏 𝘾𝙍𝙀𝘼𝙏𝙊𝙍 & 𝙊𝙒𝙉𝙀𝙍  💚👨‍🔧🔥*';
    ...
    try {
        ...
        await socket.sendMessage(from, {
            text: `💚 𝕃𝔼ℍ𝔸ℕ X MINI BOT OWNER & CREATOR 💚\n\n👨‍🔧 Name: ${ownerName}\n💭 ηυмвєя ➥ ${ownerNumber}\n\n> 𝘚𝘏𝘖𝘕𝘜-𝘟-𝘔𝘋-𝘔𝘐𝘕𝘐-𝘉𝘖𝘛- 💚🔥`,
            contextInfo: {
...
𝕃𝔼ℍ𝔸ℕ-𝘟-𝘔𝘋-𝘔𝘐𝘕𝘐-𝘉𝘖𝘛- 💚🔥`;
    ...
    await socket.sendMessage(from, {
      ...
      caption,
      footer: '𝕃𝔼ℍ𝔸ℕ мιηι вσт ву 𝕃𝔼ℍ𝔸ℕ 𝕋ℍ𝔼𝕁𝔸ℕ𝔸 👨‍🔧💚🔥',
      buttons: templateButtons,
      headerType: 1,
    }, { quoted: msg });
...
case 'song': {
  ...
  try {
    ...
    const caption = `💚🧩 𝕃𝔼ℍ𝔸ℕ x ᴍᴅ ᴍɪɴɪ ʙᴏᴛ ꜱᴏɴɢ ᴅᴏᴡɴʟᴏᴀᴅ 💚🧩
...
> 𝘚𝘏𝘖𝘕𝘜-𝘟-𝘔𝘋-𝘔𝘐𝘕𝘐-𝘉𝘖𝘛- 💚🔥`;
    ...
    await socket.sendMessage(from, {
      ...
      footer: '𝕃𝔼ℍ𝔸ℕ 𝕏 𝕄𝔻 ℙ𝕆𝕎ℝ𝔼𝔻 𝔹𝕐 𝕃𝔼ℍ𝔸ℕ 𝕋ℍ𝔼𝕁𝔸ℕ𝔸 👨‍🔧⚡',
      buttons: templateButtons,
      headerType: 1
    }, { quoted: msg });
  ...
  break;
    ...
    try {
        ...
        await socket.sendMessage(sender, {
            ...
            mimetype: "audio/mpeg",
            fileName: `L̬̂Ê̬Ĥ̬Â̬N̬̂ x ᴍɪɴɪ ʙᴏᴛ ᴍᴘ3ᴅᴏᴄ 💚💆‍♂️🎧`
        }, { quoted: msg });
...
case 'fb': {
  ...
  try {
    ...
    const url = args[0];
    const caption = ` 💚 *L̬̂Ê̬Ĥ̬Â̬N̬̂ 𝘟 𝘔𝘋 𝘔𝘐𝘕𝘐 𝘉𝘖𝘛 𝘍𝘉 𝘋𝘖𝘞𝘕𝘓𝘖𝘋𝘌𝘙* ❤️

💚 *Title:* ${fb.title}
🧩 *URL:* ${url}

> L̬̂Ê̬Ĥ̬Â̬N̬̂-𝘟-𝘔𝘋-𝘔𝘐𝘕𝘐-𝘉𝘖𝘛- 💚🔥
...
case 'niko': {
    try {
        ...
        const captionText = '💚 [ L̬̂Ê̬Ĥ̬Â̬N̬̂ x ᴍɪɴɪ ʙᴏᴛ ɴɪᴋᴏ ᴀɴɪᴍᴇ ɪᴍᴀɢᴇ ]❤️';
